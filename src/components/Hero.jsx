                ...
                >
                    ...
                    {config.heroSubCopy.map((para, i) => (
                        <motion.p
                            ...
                            className={`text-sm sm:text-base text-slate-600 dark:text-slate-300 font-light max-w-2xl mx-auto leading-relaxed ${
