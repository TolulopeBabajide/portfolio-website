...
const About = () => {
    return (
        <section id="about" className="py-2 sm:py-10 px-2 sm:px-6 text-start border-gray-200/80 dark:border-slate-800/80 bg-gray-50/40 dark:bg-slate-950/40" aria-labelledby="about-heading">
            <div className=" mx-auto">
                ...
                >
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base pb-3 sm:pb-5 leading-relaxed">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-slate-600 dark:text-slate-300 max-w-6xl mx-auto mb-2 sm:mb-10 leading-relaxed">
