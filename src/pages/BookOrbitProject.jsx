                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                <div className="space-y-6">
                                    <div className="bg-slate-900/30 p-6 rounded-xl border border-slate-800/50">
                                        ...
                                        <p className="text-slate-400 text-sm">Utilized a MySQL database with Sequelize ORM. Implemented explicit transactions with row-level locks on critical inventory tables to prevent race conditions during concurrent user actions.</p>
                                    </div>
                                    <div className="bg-slate-900/30 p-6 rounded-xl border border-slate-800/50">
                                        <h4 className="text-slate-200 font-medium mb-2">Scalable File Workflows</h4>
                                        <p className="text-slate-400 text-sm">Automated digital asset management using AWS S3. Engineered middleware to handle multipart file uploads via streams, significantly reducing memory overhead on the application server.</p>
                                    </div>
                                </div>
